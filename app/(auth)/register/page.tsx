      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-semibold text-white">Freelora</span>
          </div>
          
          <div className="space-y-8">
            <h1 className="text-4xl font-bold text-white leading-tight text-balance">
              Start managing your freelance career today
            </h1>
            <div className="space-y-4">
              {[
                "Track unlimited clients and projects",
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="lg:hidden flex items-center gap-3 justify-center">
            ...
            <span className="text-2xl font-semibold text-foreground">Freelora</span>
          </div>
